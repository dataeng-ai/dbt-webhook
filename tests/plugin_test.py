...
class TestDbtWebhook(unittest.TestCase):
    ...
    def _test_initialization_started(self):
    ...
    def _test_env_var_not_defined(self):
    ...
    def _test_command_start_hook_success(self):
    ...
    def _test_command_end_hook_success(self):
    ...
    def _test_model_start_hook_success(self):
    ...
    def _test_model_end_hook_success(self):
